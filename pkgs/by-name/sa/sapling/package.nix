...
python311Packages.buildPythonApplication {
  ...
  HGNAME = "sl";
  LIBCLANG_PATH = lib.optionalString stdenv.hostPlatform.isLinux "${lib.getLib libclang}/lib";
  ...
  checkPhase = lib.optionalString stdenv.hostPlatform.isLinux ''
    substituteInPlace eden/scm/sapling/thirdparty/pysocks/setup.py \
      --replace-fail 'os.path.dirname(__file__)' "\"$out/eden/scm/sapling/thirdparty/pysocks\""
  '';
